...
@InputType()
class ListingCreateNestedManyWithoutDirectoriesInput {
...
export { ListingCreateNestedManyWithoutDirectoriesInput as ListingCreateNestedManyWithoutDirectoriesInput };
